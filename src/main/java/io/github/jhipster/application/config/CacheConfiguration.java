...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, io.github.jhipster.application.domain.PushkarJhipster.class.getName());
            createCache(cm, io.github.jhipster.application.domain.BookEntity.class.getName());
